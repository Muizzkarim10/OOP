...
public class MyPanel extends JPanel {
   ...
   public MyPanel() {
        backgroundImage = new ImageIcon("build/classes/finalproject/backs.png");
        obstacle = new ImageIcon("build/classes/finalproject/ob.png");
        obstacle2 = new ImageIcon("build/classes/finalproject/up.png");
        flap = new ImageIcon("build/classes/finalproject/flap.png");
